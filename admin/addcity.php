...
<tr><td class="lefttd">Pin Code</td><td><input type="" name="t2" required="required" pattern="[0-9]{6,10}" title="please enter only numbers between 6 to 10 for pin code"/></td></tr>
