    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container py-5">
            ...
            <img src="images/camps.png" height="80px" style="margin-top:100px;" />
            </div>
            </div>
             <div class="row mt-4">
  ...
  if($r)
    {
      ...
      {?>
       <div class="col-md-4">
                  ...
                  <h2 style="font-family: 'Itim', cursive;color:white;"><?php echo $data[1]; ?></h2>
                  <div align="center">
                  <div class="card-img bg-dark mb-3">
                   <a href="admin/pic/<?php echo $data[5] ?>"> <img src="admin/pic/<?php echo $data[5] ?>" height="100%" width="100%" style="margin:auto;border-radius:10px;" /></a>
                      </div>
                      </div>
                      <div class="card-body">
                      ...
                      <div style="border-radius:10px;">
                        <div class="card-text list-group-item"style="vertical-align:middle"><h5 style="font-family: 'Itim', cursive;">Organised By:<?php echo $data[2]; ?></h5></div>
                        <div class="card-text list-group-item"style="vertical-align:middle"><h5 style="font-family: 'Itim', cursive;">City nearby:<?php echo $data[10]; ?></h5></div>
                        <div class="card-text list-group-item"style="vertical-align:middle"><h5 style="font-family: 'Itim', cursive;"><?php echo $data[6]; ?></h5></div>
                        </div>
                     </div>
                   </div>
               </div>
