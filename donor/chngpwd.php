...
<input type="password" name="t3"  required="required" pattern="[a-zA-Z0-9]{2,10}" title="please enter only character or numbers between 2 to 10 for new password" /></div>
<div class="form-group">
         <label>Comfirm Password:</label><br>  
<input type="password"  required="required" pattern="[a-zA-Z0-9]{2,10}" title="please enter only character or numbers between 2 to 10 for confirm password" name="t4"/></div>
<div class="modal-footer"><center>
<input class="btn btn-warning"type="submit" value="Change" name="sbmt"/>	
</div>
</form>
</div>
    </div></div></div>
