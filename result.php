      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="container py-5">
            ...
            <img src="images/results.png"height="80px" style="margin-top:100px;"/></div>
            </div>
            </div>
             <div class="row mt-4">
  ...
  if($r)
    {
      ...
      {?>
       <div class="col-md-4">
                  ...
                  <div class="card-img bg-dark mb-3">
                  <a href="doner_pic/<?php echo $data[8] ?>"data-lightbox="image-1"> <img src="doner_pic/<?php echo $data[8] ?>" height="100%" width="100%"></a> </div>
                      <div class="card-body">

                        
                     
                      <div style="border-radius:10px;">
                        <div class="card-text list-group-item"style="vertical-align:middle"><h5 style="font-family: 'Itim', cursive;"> Name:&nbsp;&nbsp;<?php echo $data[1]; ?></h5></div>
              
                        <div class="card-text list-group-item"style="vertical-align:middle"><h5 style="font-family: 'Itim', cursive;"> Gender:&nbsp;&nbsp;<?php echo $data[2]; ?></h5></div>
                        <div class="card-text list-group-item"style="vertical-align:middle"><h5 style="font-family: 'Itim', cursive;"> Mobile No:&nbsp;&nbsp;<?php echo $data[4]; ?></h5></div>
                        <div class="card-text list-group-item"style="vertical-align:middle"><h5 style="font-family: 'Itim', cursive;"> Email:&nbsp;&nbsp;<?php echo $data[6]; ?></h5></div>
                        <div class="card-text list-group-item"style="vertical-align:middle"><h5 style="font-family: 'Itim', cursive;"> Blood Group:&nbsp;<?php echo $data[10]; ?></h5></div>
                        </div>
                   </div>
               </div>
            </div>
